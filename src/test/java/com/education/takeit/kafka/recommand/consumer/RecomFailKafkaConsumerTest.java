...
class RecomFailKafkaConsumerTest {
    @Mock
    private RecomFailLogService recomFailLogService; // RecomFailLogService 모의 객체

    @Mock
    private SlackNotifier slackNotifier; // SlackNotifier 모의 객체

    @Mock
    private Acknowledgment acknowledgment; // Acknowledgment 모의 객체

    @InjectMocks
    private RecomFailKafkaConsumer consumer;
