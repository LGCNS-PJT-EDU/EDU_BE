...
class FeedbackFailKafkaConsumerTest {
  ...
  @Mock private FeedbackFailLogService feedbackFailLogService;

  @Mock private SlackNotifier slackNotifier;

  @Mock private Acknowledgment acknowledgment;

  @InjectMocks private FeedbackFailKafkaConsumer consumer;

  private FeedbackFailDto testPayload;

  @BeforeEach
  void setUp() {
    testPayload = new FeedbackFailDto(1L, 1L, "pre", 1, "FEEDBACK_REQ_ERROR", "THIS IS ERROR");
  }
