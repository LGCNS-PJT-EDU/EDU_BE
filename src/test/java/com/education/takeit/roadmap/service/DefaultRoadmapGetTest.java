...
public class DefaultRoadmapGetTest {
    ...
    void getDefaultRoadmap_BE() {
        ...
        Subject subject3 = Subject.builder()
                ...
                .subEssential("Y")
                .baseSubOrder(3)
                .subOverview("Git & GitHub란? 코드를 안전하게 관리하고, 함께 작업할 수 있게 해주는 도구! 코드를 버전별로 저장하고, 이전 상태로 되돌리거나 여러 사람이 동시에 작업해도 충돌 없이 관리할 수 있어요. 예를 들면, 실수로 코드를 잘못 고쳐도 이전 상태로 복원할 수 있고, 팀원이 만든 기능을 병합하거나 비교할 수도 있어요. Git은 버전 관리 시스템, GitHub는 이 Git 저장소를 인터넷에 저장하고 협업할 수 있게 해주는 서비스라고 생각하면 돼요.")
                .track(track2)
                .build();
    ...
    void getDefaultRoadmapException(){
        ...
        CustomException exception = assertThrows(CustomException.class, () ->
                    roadmapService.getDefaultRoadmap("AI")
                );
