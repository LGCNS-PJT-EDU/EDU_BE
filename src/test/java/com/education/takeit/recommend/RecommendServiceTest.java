...
public class RecommendServiceTest {
    ...
    void 사용자_과목별_추천_컨텐츠_조회_성공(){
        //given
        when(userContentRepository.findByUser_UserIdAndSubject_SubId(userId,subject.getSubId())).thenReturn(List.of(userContent));

        //when
        List<UserContentResDto> result = recommendService.findRecommendations(userId,subject.getSubId());
    ...
    void 사옹자_추천_컨텐츠_저장_성공(){
        ...
        RecomResultDto recomResultDto = new RecomResultDto(
                userId,
                subject.getSubId(),
                List.of(new UserContentResDto(
        ...
        when(totalContentRepository.findById(content.getTotalContentId())).thenReturn(Optional.of(content));
    ...
    void 추천_콘텐츠_저장_실패_컨텐츠_없음() {
        ...
        RecomResultDto dto = new RecomResultDto(
                userId,
                subject.getSubId(),
                List.of(new UserContentResDto(
