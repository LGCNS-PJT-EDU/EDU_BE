...
public class ExamServiceTest {
    ...
    @Mock
    private FeedbackKafkaProducer feedbackKafkaProducer;
    @Mock
    private RecomKafkaProducer recomKafkaProducer;
    @Mock
    private ExamLevelCalculator examLevelCalculator;
    @Mock
    ...
    void testFindPreExam(){
        Long userId=1L;
        Long subjectId=10L;
        ExamResDto exam1 = ExamResDto.builder()
                .questionId(1L)
                .question("문제1")
                .choice1("A")
                .choice2("B")
        ...
        ExamResDto exam2 = ExamResDto.builder()
                .questionId(2L)
                .question("문제2")
                .choice1("A")
                .choice2("B")
    ...
    void testSubmitPreExam() {
        ...
        ExamAnswerResDto examAnswerRes = new ExamAnswerResDto(
                roadmapId, subjectId, startDate, duration, submitCnt, answers
        );
        ...
        SubjectResultDto subjectResult = new SubjectResultDto(subjectId, startDate, duration, submitCnt + 1, 2, 1, 1);
    ...
    void testSubmitPostExam() {
        ...
        ExamService spyService = Mockito.spy(examService);
        SubjectResultDto subjectResult = new SubjectResultDto(subjectId, startDate, duration, submitCnt + 1, 3, 1, 1);
        ChapterResultDto chapterResult = new ChapterResultDto(1, "챕터1", false, 1, 1);
