...
INSERT INTO exam(exam_id, exam_content, exam_answer, exam_level, option1, option2, option3, option4, sub_id, solution) VALUES
    ...
    (290 4, 'Dockerfile에서 Flask 앱 실행을 위해 자주 사용하는 명령은?', 3, 'medium', 'flask serve', 'python run.py', 'gunicorn app:app', 'nginx -g \'daemon off;\'', 59, 'gunicorn app:app은 Flask 앱을 WSGI 서버인 Gunicorn을 통해 실행하는 명령이다.'),
