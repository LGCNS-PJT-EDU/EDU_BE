...
public class UserInterviewReplyService {
    ...
    @Transactional
    public InterviewFeedbackResDto saveReplyAndRequestFeedback(UserInterviewReplyReqDto reqDto, User user){
        Interview interview = interviewRepository.findById(reqDto.interviewId())
