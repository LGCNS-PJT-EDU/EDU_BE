...
public class RoadmapController {
  ...
  */
  ...
  public ResponseEntity<Message<MyPageResDto>> getUserProgress(
  ...
  public ResponseEntity<Message<String>> updateRoadmap(
      @AuthenticationPrincipal CustomUserDetails userDetails,
  ...
  public ResponseEntity<Message<String>> deleteRoadmap(
      @AuthenticationPrincipal CustomUserDetails userDetails) {
    {
      Long userId = userDetails.getUserId();
  ...
  public ResponseEntity<Message<SubjectFindResDto>> findUserRoadmap(
      @AuthenticationPrincipal CustomUserDetails userDetails,
  ...
  public ResponseEntity<Message<RoadmapFindResDto>> findRoadmap(
